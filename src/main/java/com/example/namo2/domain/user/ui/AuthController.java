...
public class AuthController {
    ...
    public BaseResponse<UserResponse.SignUpDto> kakaoSignup(@Valid @RequestBody UserRequest.SocialSignUpDto signUpDto) throws BaseException {
        UserResponse.SignUpDto signupDto = authService.signupKakao(signUpDto);
    ...
    public BaseResponse<UserResponse.SignUpDto> naverSignup(@Valid @RequestBody UserRequest.SocialSignUpDto signUpDto) throws BaseException {
        UserResponse.SignUpDto signupDto = authService.signupNaver(signUpDto);
        return new BaseResponse<>(signupDto);
    }
