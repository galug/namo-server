...
public class MoimController {
    ...
    public BaseResponse<ScheduleResponse.SliceDiaryDto> findMonthMoimMemo(@PathVariable("month") String month, Pageable pageable, HttpServletRequest request) {
        List<LocalDateTime> localDateTimes = converter.convertLongToLocalDateTime(month);
        ScheduleResponse.SliceDiaryDto diaryDto;
		diaryDto = moimMemoService.findMonth((Long) request.getAttribute("userId"), localDateTimes, pageable);
